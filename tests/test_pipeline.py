...
from core.verifier import ClaimVerifier, VerificationResult, SemanticSimilarityChecker
from core.firewall import FirewallDecisionEngine, FirewallDecision, HallucinationFirewall
from retrieval.retriever import RetrievedEvidence
from ingestion.loader import DocumentIngestion
...
class TestEndToEnd:
    ...
    def test_claim_to_verification_flow(self):
        ...
        engine = FirewallDecisionEngine(threshold=0.5)
        decision = engine.evaluate(results)
