...
from config import REFINED_GENERATION_PROMPT
...
if __name__ == "__main__":
    ...
    print("Prompt Refiner Module - Test")
    print("-" * 40)
    
    from claim_extractor import Claim
    from verifier import VerificationResult
    from firewall import FirewallResult, FirewallDecision
    
    # Create mock firewall result
    mock_results = [
        VerificationResult(
            ...
            best_evidence="Python was first released in 1991 by Guido van Rossum.",
            evidence_source="wiki"
        ),
        VerificationResult(
            claim=Claim(text="Python is the most popular language", claim_id=1),
            is_supported=False,
            similarity_score=0.4,
            entailment_label='NEUTRAL',
            entailment_score=0.5,
            best_evidence="Python is a popular programming language.",
            evidence_source="wiki"
        ),
    ]
    ...
    print(result)
    print("\n--- Refined Prompt ---")
    print(result.refined_prompt[:500] + "...")
