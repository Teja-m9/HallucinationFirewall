...
from embeddings import EmbeddingModel, compute_cosine_similarity
...
if __name__ == "__main__":
    ...
    # Create test claims
    claims = [
        Claim(text="Python was released in 1991", claim_id=0),
        Claim(text="Python was created by Guido van Rossum", claim_id=1),
        Claim(text="Python is written in Java", claim_id=2),  # False claim
    ]
    
    # Create test evidence
    evidence = [
        RetrievedEvidence(
            content="Python is a programming language created by Guido van Rossum and first released in 1991.",
            similarity_score=0.9,
            metadata={"source": "wiki"},
            rank=1
        ),
        RetrievedEvidence(
            content="Python emphasizes code readability and supports multiple programming paradigms.",
    ...
    for claim in claims:
        ...
        print(f"\n{result}")
        print(f"  Best Evidence: {result.best_evidence[:60]}...")
    ...
    print(f"  Supported: {summary['supported_claims']}")
    print(f"  Unsupported: {summary['unsupported_claims']}")
    print(f"  Support Ratio: {summary['support_ratio']:.2%}")
