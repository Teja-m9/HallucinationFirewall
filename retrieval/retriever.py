...
from ingestion.embeddings import VectorStore, EmbeddingModel
from ingestion.loader import DocumentChunk, DocumentIngestion
...
class Retriever:
    ...
    def get_context_string(
        ...
        for evidence in evidence_list:
            context_parts.append(evidence.content)
